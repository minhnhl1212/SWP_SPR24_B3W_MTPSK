<%-- 
    ...
    Created on : Apr 11, 2024, 8:28:23 PM
    Author     : TUF
--%>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="footer-about">
                            <p>Hệ thống cửa hàng đồ chơi dành cho em bé Kids Store. Đơn vị chủ quản: Công ty Cổ Phần Thương Mại Kids Store </p>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="useful-link">
                            ...
                            <div class="use-links">
                                <li><i class='bx bx-chevrons-right'></i>Home</li>
                                <li><i class='bx bx-chevrons-right'></i>About Us</li>
                                <li><i class='bx bx-chevrons-right'></i>Gallery</li>
                                <li><i class='bx bx-chevrons-right'></i>Contact</li>
                            </div>
                        </div>
        ...
        <section id="copy-right">
            <div class="copy-right-sec"><i class="fa-solid fa-copyright"></i>  
                Copyright © 2022 KidsStore. Designed by WES JSC. All Rights Reserved.</a>
            </div>
        </section>
